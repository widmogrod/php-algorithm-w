...
const composeSubst = 'AlgorithmW\composeSubst';
...
class AlgorithmWTest extends \PHPUnit\Framework\TestCase
{
    /**
     * @dataProvider provideAlgorithmWs
     */
    ...
    public function provideAlgorithmWs()
    {
        return [
            '2' => [
